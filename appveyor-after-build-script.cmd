...
"C:\Program Files (x86)\Inno Setup 5\ISCC.exe" "%APPVEYOR_BUILD_FOLDER%\setup-script.iss" -DMyAppVersion=%APPVEYOR_BUILD_VERSION% -DArch=%PLATFORM% -DMyOutputDir=%APPVEYOR_BUILD_FOLDER%\%PLATFORM%\%CONFIGURATION%\
)